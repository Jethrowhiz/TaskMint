  ...
  return (
    <main className="container">
      <header className="mb-12">
        <a href="/" className="inline-block mb-8 font-medium hover:underline transition-colors" style={{color: 'var(--accent)'}}>
          ← BACK TO HOME
        </a>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8">
          ...
          <a href="/create-bounty" className="btn px-6 py-3 shadow-lg hover:shadow-xl whitespace-nowrap" style={{backgroundColor: 'var(--primary)', color: 'var(--secondary)'}}>
            CREATE BOUNTY
          </a>
        </div>
      </header>
